...
docker buildx build --progress=plain --build-arg "CPU_CORES=$CPU_CORES" --build-arg "GMP_VERSION=$GMP_VERSION" --build-arg "GDB_VERSION=$GDB_VERSION" --build-arg "MPFR_VERSION=$MPFR_VERSION" -t "gdb-cross-builder:$GDB_VERSION" .
